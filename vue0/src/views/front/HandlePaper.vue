<template>
  <el-card style="margin: 10px 0">
    <div style="margin-bottom: 20px">得分：<span style="color: red">{{ score }}</span></div>
    <el-table :data="paper" stripe>
<!--      <el-table-column prop="id" label="题目ID" width="80" sortable></el-table-column>-->
      ...
      <el-table-column prop="studentAnswer" label="我的答案"></el-table-column>
